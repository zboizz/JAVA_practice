...
public class DrawAllEx01 extends MFrame 
implements ActionListener {
	...
	public void selectPanel(int mode) {
		switch (mode) {
			...
			case 2://원 그리기
				...
				rcb.setBackground(Color.GREEN);
				gcb.setBackground(Color.GREEN);
				bcb.setBackground(Color.GREEN);
				p2.add(fillcb, 8);
				break;
		}
	}
	...
	class MCanvas extends Canvas{
		...
		public void paint(Graphics g) {
			...
			switch (mode) {
				case 0: g.drawLine(a[0], a[1], a[2], a[3]);
					break;
				case 1: 
					if(fillcb.getState())
